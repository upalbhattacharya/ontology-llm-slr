...
\citet{li2025LargeLanguageModels}. Articles from the citation list published
after 2017 are considered. For each of these articles, manual inspection for
...
considered valid. Otherwise, we re-check the set of keywords, with special
