...
For the ScienceDirect (Section \ref{subsubsec:sciencedirect}), ACL Anthology
(Section \ref{subsubsec:acl}), ACM Digital Library (Section
\ref{subsubsec:acm}) and ArXiv (Section \ref{subsubsec:arxiv}) sources, CSV
files are not directly available. For
