...
articles, a seed list of articles is curated. The seed list is obtained by
considering all 25 manually identified relevant articles as discussed in
Section \ref{subsec:keyword-selection}
