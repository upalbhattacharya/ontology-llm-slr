...
Deduplication across the entire initial pool was performed using the
\href{https://github.com/ChenglongMa/zoplicate}{zooplicate} plugin for
Zotero. 1157 duplicates were identified and 815 were automatically
deduplicated by zooplicate.
