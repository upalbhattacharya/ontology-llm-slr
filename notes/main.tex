...
\subsection{Conversion of bib to csv}
...
\ref{subsubsec:arxiv}) sources. For theses sources, the provided \verb|bibtex|
files are loaded in to \href{https://www.zotero.org}{Zotero} and the CSV
